// after block-pool , validators now verify the proposal and then broadcast a PREPARE message to the other validators
// validators wait for 2f+1 valid PREPARE messages , and then enter PREPARED state
